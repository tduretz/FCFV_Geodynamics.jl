...
function ShapeFunctions(ipx, nip, nnel)
    ...
    for i=1:nip
        ...
        elseif nnel==4
            ...
            dNdx[i,:,:] .= [-1-3*η2*η3+η3*(-3*η2-3*η3+3.0)  1-3*η2*η3+η3*(-3*η2-3*η3+3.0) 0-3*η2*η3+η3*(-3*η2-3*η3+3.0) -27*η2*η3+27*η1*η3;  #w.r.t η2
                            -1-3*η2*η3+η2*(-3*η2-3*η3+3.0)  0-3*η2*η3+η2*(-3*η2-3*η3+3.0) 1-3*η2*η3+η2*(-3*η2-3*η3+3.0)  27*η1*η2-27*η2*η3]' #w.r.t η3
        elseif nnel==6
