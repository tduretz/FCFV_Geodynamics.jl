...
p = Plots.plot!( log10.(1.0 ./ N) , log10.(eT_quad_o2), markershape=:rect, color=:red,      label="Quads O1 u"     )
p = Plots.plot!( log10.(1.0 ./ N) , log10.(eq_quad_o2), markershape=:rect, color=:red, linestyle = :dot,     label="Quads O1 q"     )
p = Plots.plot!( log10.(1.0 ./ N) , log10.(eT_tri_o2),  markershape=:dtriangle, color=:red, label="Triangles O1 u" )
p = Plots.plot!( log10.(1.0 ./ N) , log10.(eq_tri_o2),  markershape=:dtriangle, color=:red, linestyle = :dot, label="Triangles O1 q", legend=:bottomright, xlabel = "log_10(h_x)", ylabel = "log_10(err_T)" )
